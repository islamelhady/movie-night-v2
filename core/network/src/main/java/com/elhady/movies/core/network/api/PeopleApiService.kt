...
import com.elhady.movies.core.network.dto.people.MoviesByPeopleDto
...
import com.elhady.movies.core.network.dto.people.TvShowsByPeopleDto
...
interface PeopleApiService {
    ...
    suspend fun getMoviesByPerson(@Path("person_id") personId: Int): Response<MoviesByPeopleDto>

    @GET("person/{person_id}/tv_credits")
    suspend fun getTvShowsByPerson(@Path("person_id") personId: Int): Response<TvShowsByPeopleDto>
}
